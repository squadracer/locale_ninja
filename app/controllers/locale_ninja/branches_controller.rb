...
module LocaleNinja
  class BranchesController < ApplicationController
    ...
    def show
      ...
      locales = locales(@client.locale_files_path(branch: branch_to_pull(@branch_name)))
      all_translations = all_keys_for_locales(@client.pull(branch: @branch_name), locales)
